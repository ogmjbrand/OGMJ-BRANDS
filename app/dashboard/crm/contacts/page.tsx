      ...
      <div className="bg-[#0E1116] border border-[#C8FF00]/10 rounded-xl overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <button className="px-4 py-2 bg-[#C8FF00]/20 text-[#C8FF00] rounded-lg font-medium hover:bg-[#C8FF00]/30 transition">
                ...
                {contacts.map((contact) => (
                  <tr key={contact.id} className="border-b border-[#C8FF00]/10 hover:bg-[#07070A]/50 transition">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button className="p-2 text-[#C8FF00]/50 hover:text-[#C8FF00] rounded-lg hover:bg-[#C8FF00]/10 transition">
